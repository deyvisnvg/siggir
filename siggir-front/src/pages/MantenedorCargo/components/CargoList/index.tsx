...
export default function CargoList({ getCargo }: Props) {
    ...
    const Items = (idCargo: number) => [
        ...
        },
        {
            ...
            onclick: () => handleOpenModal('edit', { getCargo, idCargo }),
        },
    ]
            ...
            <Table>
                <TableHeader>
                    <TableRow className='*:bg-gray-600 *:text-white'>
                        ...
                        <TableHead>
                            <div className="w-auto">Area Perteneciente</div>
                        </TableHead>
                ...
                <TableBody>
                    {current.map((item: any) => (
                        <TableRow key={item.cargoId}>
                            <TableCell>{item.cargoNombre}</TableCell>
                            <TableCell>{item['area.areaNombre']}</TableCell>
