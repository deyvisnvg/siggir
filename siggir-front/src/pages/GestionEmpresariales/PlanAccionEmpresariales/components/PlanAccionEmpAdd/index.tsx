...
import { AreaController, CatalogoController, PlanAccionController } from "@/controllers";
...
export default function PlanAccionEmpAdd({ getPlanAccionByIdRiesgo, idRiesgo, setOpenModal }: Props) {
    const [areasTreeData, setAreasTreeData] = useState<TreeNode[]>([]);

    const { createPlanAccion } = PlanAccionController();
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            ...
            const response = await createPlanAccion(formData);
