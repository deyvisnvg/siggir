...
export default function PlanAccionEmpList({ idRiesgo, getPlanAccionByIdRiesgo }: Props) {
    ...
    const Items = (idPlanAccion: number) => [
        {
            href: "",
            label: 'Visualizar',
                        ...
                        <tbody>
                            {
                                current.map((item: any) => (
                                    <tr key={item.planAccion_id} className="bg-white border-b border-gray-200 hover:bg-gray-50">
                                        <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                            {item.planAccion_codigo}
                                        </th>
                                        <td className="px-6 py-4">
                                            {item.planAccion_descripcion}
                                        </td>
                                        <td className="px-6 py-4">
                                            <DropdownComponent
                                                iconButtonDropdown={
                                                ...
                                                items={Items(item.planAccion_id)}
